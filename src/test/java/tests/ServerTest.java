...
public class ServerTest extends ApplicationTest{
    ...
    public void twoClientsConnectToServer() {
        Gdx.app.postRunnable(() -> {
            ...
            try {
                GameClient client1 = new GameClient("localhost","test", new MultiplayerGameHandler(2));
            } catch (IOException e) {
                e.printStackTrace();
            }
            try {
                GameClient client2 = new GameClient("localhost","test", new MultiplayerGameHandler(2));
            } catch (IOException e) {
                e.printStackTrace();
            }
